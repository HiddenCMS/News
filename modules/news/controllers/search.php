...
class Search extends Controller_Module
{
	...
	{
		$this->db	->select('n.news_id', 'n.date', 'nl.title', 'nl.slug', 'nl.introduction', 'nl.content', 'u.id as user_id', 'u.username', 'c.category_id', 'c.name as category_name', 'cl.title as category')
					->from('news n')
