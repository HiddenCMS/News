...
<div class="card-footer">
	...
	<?php endif ?>
	<?php if ($content): ?>
		<a href="<?php echo url($news_module->news_path($category_name, $title, isset($slug) ? $slug : '')) ?>" class="btn btn-sm btn-secondary float-right"><?php echo $this->lang('Continuer à lire') ?></a>
	<?php endif ?>
</div>
<?php endif ?>
